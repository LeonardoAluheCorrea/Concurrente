...
public class GrafoEtiquetado {
    ...
    public Object obtenerElemento(Object buscado){
        ...
        return ubicarVertice(buscado).getElemento();
    }
    ...
    public boolean eliminarArco(Object origen, Object destino){
        ...
        if (aux != null){
            ...
            if (auxAdyA.getVertice().getElemento().equals(destino)){
                aux.setPrimerAdy(auxAdyA.getSigAdyacente());
                aux = auxAdyA.getVertice();
            }
            else{
                //Caso general: el enlace no esta en el primer adyacente
                //Buscamos el adyacente que contiene el enlace al destino
                auxAdyB = aux.getPrimerAdy();
                while (auxAdyA != null && !auxAdyA.getVertice().getElemento().equals(destino)){
                    auxAdyB = auxAdyA;
            ...
            if (auxAdyA.getVertice().getElemento().equals(origen)){
                ...
                auxAdyB = aux.getPrimerAdy();
                while (auxAdyA != null && !auxAdyA.getVertice().getElemento().equals(origen)){
                    auxAdyB = auxAdyA;
                    auxAdyA = auxAdyA.getSigAdyacente();
                }
                if (auxAdyA != null){
    ...
    public boolean eliminarVertice(Object buscado){
        ...
        auxB = auxA;
        exito = false;
        //Primero buscamos el vertice a eliminar
        //Caso especial: eliminamos el inicio
        if (auxA.getElemento().equals(buscado)){
