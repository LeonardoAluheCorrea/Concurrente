...
public class EDATViajes {
    ...
    public static void main(String[]args) throws IOException{
        ...
        System.out.println("EL ARCHIVO LOG SE CREA EN <  C:\\  > AL REALIZARSE LA PRECARGA INICIAL CON NOMBRE LOG");
    ...
    public static boolean eliminarVuelo(Diccionario tablaVuelos, GrafoEtiquetado mapa){
        ...
        if (codigo.length() == 6){
            //Antes de eliminar el vuelo los guardamos, para poder obtener los aeropuertos de origen y destino
            Vuelo porEliminar;
            ...
            if (porEliminar != null){
                ...
                exito = exito && mapa.eliminarArco(new Aeropuerto(porEliminar.getOrigen()), new Aeropuerto(porEliminar.getDestino()));
    ...
    public static boolean modificarVuelo(Diccionario tablaVuelos, GrafoEtiquetado mapa){
        ...
        if (codigo.length() == 6){
            ...
            if (porModificar != null){
                ...
                //Preguntamos si quiere añadir viajes a la lista de viajes del vuelo
                agregarViajesAVuelo(porModificar);
                //Preguntamos por el resto de los atributos
                ...
                //Debemos cambiar la ruta entre aeropuertos y tal vez tambien la etiqueta que marca la duracion del vuelo 
                int duracionVuelo;
                //Calculamos la duracion aproximada del vuelo en minutos
                duracionVuelo = porModificar.getHoraSalida() - porModificar.getHoraLlegada();
                ...
                if (modificado){
                    ...
                    mapa.eliminarArco(nombreOrigenViejo, nombreDestinoViejo);
                    mapa.insertarArco(porModificar.getOrigen(), porModificar.getDestino(), duracionVuelo);
                    //Avisamos la modificacion por el log
                    String aviso = "El vuelo: " + new Vuelo(porModificar.getCodigo(), nombreOrigenViejo, nombreDestinoViejo, horaSalidaVieja, horaSalidaVieja)
        ...
        if (tablaClientes.pertenece(claveCliente)){
            ...
            if (codigoVuelo.length() == 6){
                ...
                if (tablaVuelos.pertenece(codigoVuelo)){
                    ...
                    fecha = TecladoIn.readLine();
                    //Nos fijamos si existe un viaje en el vuelo que tenga en esa fecha y con asientos libre
                    Pasaje nuevo;
    ...
    public static boolean verificarCompraPasaje(Diccionario tablaVuelos, Pasaje comprado){
        ...
        //Ahora revisamos sus lista de viajes 
    ...
    public static boolean modificarPasaje(HashMap <ClavePersona, Lista> pasajesComprados, Diccionario tablaVuelos){
        ...
        Lista comprados;
        comprados = pasajesComprados.get(claveCliente);
        //Nos aseguramos que la lista no este vacia
        if (!comprados.esVacia()){
            ...
            if(estado.equalsIgnoreCase("pendiente") || estado.equalsIgnoreCase("volado") || estado.equalsIgnoreCase("cancelado")){
                ...
                System.out.println(comprados.localizar(new Pasaje(nroAsientos, codigoVuelo, fecha, estado)));
    ...
    public static Lista obtenerClientesFieles(HashMap <ClavePersona, Lista> pasajesComprados, Diccionario tablaClientes){
        ...
        Heap auxiliar;
        auxiliar = new Heap(pasajesComprados.size());
    ...
    public static int menuGeneral(){
        ...
        System.out.println("8. Obtener un listado de los clientes ordenado de mayor a menor dependiendo cuantos pasajes han comprado");
    ...
    public static boolean modificarCliente(Diccionario tablaClientes){
        ...
        Cliente porModificar;
        porModificar = (Cliente) tablaClientes.obtenerInformacion(new ClavePersona(tipoDni, nroDni));
        //Obtener informacion devuelve un null si el cliente no existe en la tabla asi que debemos chequear que este no se el caso antes de continuar
        if (porModificar != null){
    ...
    public static void cargarAeropuerto(GrafoEtiquetado mapa, String linea){
        ...
        //Cargamos el aeropuerto al mapa
        nuevo = new Aeropuerto(nombre,ciudad, telefono);
    ...
    public static void cargarViajes(Lista viajes, String linea){
        ...
        viajes.insertar(new Viaje(fecha, asientosTotales, asientosVendidos), viajes.longitud() + 1);
    }
    ...
    public static void cargarVuelo(GrafoEtiquetado mapa, Diccionario tablaVuelos, String linea, Lista viajes){
        ...
        //Insertamos el arco que representa al vuelo
        mapa.insertarArco(new Aeropuerto(origen), new Aeropuerto(destino), llegada - salida);
        //Insertamos el vuelo en la tabla de vuelos
        tablaVuelos.insertar(codigo, nuevo);
    }
    ...
    public static void cargarCliente(Diccionario tablaClientes, HashMap <ClavePersona, Lista> pasajesComprados, String linea, Lista comprados){
        ...
        //Añadimos el cliente a la tabla de clientes
        tablaClientes.insertar(clave, nuevo);
    ...
    public static void cargarDatos(GrafoEtiquetado mapa, Diccionario tablaVuelos, Diccionario tablaClientes, HashMap <ClavePersona, Lista> pasajesComprados) throws FileNotFoundException, IOException{
        ...
        BufferedReader b;
        String rutaArchivo;
        System.out.println("Ingrese la ruta del archivo txt que contiene los datos");
        rutaArchivo = TecladoIn.readLine();
    ...
    public static void aniadirALog(String contenido){     
        ...
        try {
            String ruta = "C:\\Users\\Leo\\Desktop\\LOG";
