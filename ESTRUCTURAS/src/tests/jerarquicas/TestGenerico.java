...
public class TestGenerico {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("\n");
        System.out.println("\n");
        System.out.println("A continuacion probaremos el metodo frontera correspondiente al trabajo de reentrega del arbol generico");
        System.out.println("Frontera del arbol, debe dar: [ 7 , 10 , 12 , 20 , 22 , 40 , 45 , 55 ]   " + a.frontera().toString());
        System.out.println("Inserto 2 como raiz en nuevo arbol");
        b.insertar(2,null);
        System.out.println("Frontera de arbol solo con raiz, debe dar: [ 2 ]   " + b.frontera().toString());
        System.out.println("Insertamos mas elementos en el arbol");
        b.insertar(3,2);
        b.insertar(4,2);
        System.out.println("Frontera de arbol con raiz y 2 hijos, debe dar: [ 3 , 4 ]   " + b.frontera().toString());
        b.insertar(5,2);
        b.insertar(6,5);
        System.out.println("Nuevo arbol: " + b.toString());
        System.out.println("Frontera del nuevo arbol, debe dar: [ 3 , 4 , 6 ]   " + b.frontera());
        System.out.println("Vaciamos el arbol");
        b.vaciar();
        System.out.println("Frontera de arbol vacio, debe dar lista vacia: " + b.frontera().toString());
    }
